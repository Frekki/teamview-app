...
var AddsprintComponent = (function () {
    ...
    AddsprintComponent.prototype.onAddingSubmit = function () {
        ...
        // Register sprint
        this.authService.addSprint(team.teamName).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('You add new sprint to ' + team.teamName + ' team.', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMessage.show('Something went wrong', { cssClass: 'alert-danger', timeout: 3000 });
                _this.router.navigate(['/addsprint']);
            }
        });
    };
...
var AuthService = (function () {
    ...
    //Sprints
    AuthService.prototype.addSprint = function (teamName) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
